...
# Add 1st flag
RUN echo 'FLAG{this_is_the_first_one!}' > /home/ctfplayer/flag1.txt && \
    chown ctfplayer:ctfplayer /home/ctfplayer/flag1.txt
# Add 2nd flag
RUN echo 'FLAG{how_did_you_find_me!?}' > /home/ctfplayer/.flag2.txt && \
    chown ctfplayer:ctfplayer /home/ctfplayer/.flag2.txt
# Add 3rd flag
RUN echo 'FLAG{im_at_home}' > /home/flag3.txt && \
    chown ctfplayer:ctfplayer /home/flag3.txt
# Add 4th flag ( FLAG{you_read_this_right} )
RUN echo 'RkxBR3t5b3VfcmVhZF90aGlzX3JpZ2h0fQ==' > /flag4.txt && \
    chmod 744 /flag4.txt
# Add 5th flag
RUN mkdir -p /tmp/i/came/too/deep && echo 'FLAG{wow_im_back_alive!}' > /tmp/i/came/too/deep/flag5.txt && \
    chmod 744 /tmp/i/came/too/deep/flag5.txt
# Add 6th flag && hint
...
RUN chmod 755 /home/michael && \
    ...
    echo 'FLAG{keep_your_private_key_secure}' > /home/michael/flag8.txt && \
    chown michael:michael /home/michael/flag8.txt && \
    chmod 600 /home/michael/flag8.txt
# Add 9th flag & hint
RUN echo '2d61bfbcb50d147b98b46529894646f2' > /home/reina/md5_hashed_passwd.txt && \
    echo 'FLAG{be_careful_even_if_seemingly_safe}' > /home/reina/flag9.txt && \
    chown reina:reina /home/reina/flag9.txt
# Add 10th flag
RUN echo '#include <stdlib.h>' >> /home/reina/backup.c && \
    ...
    echo 'FLAG{you_are_skilled_enough!}' > /root/flag10.txt && \
    chown root:root /root/flag10.txt
